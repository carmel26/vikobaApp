...
--
-- Déchargement des données de la table `aauth_perms`
--
...
(1, 'admin@admin.com', NULL, NULL, '5711aa2253ac62088bf34f79f8ccd82e41bdbcf32e7670772d2a1e1746a9be9b', 'admin', 'admin', '', 0, '2022-01-03 22:22:15', '2022-01-03 22:22:15', '2022-01-03 16:12:35', NULL, NULL, NULL, NULL, NULL, '::1');
...
(1, 'Hello Wellcome To Ibi Builder', 'Hello-Wellcome-To-IBI-Builder', 'greetings from our team I hope to be happy! ', 'wellcome.jpg', 'greetings', '1', 'publish', 'admin', 0, '2022-01-03 16:12:35', '0000-00-00 00:00:00');
...
--
-- Déchargement des données de la table `cc_options`
--
...
(1, 'Test', 'Test', 'test', 'id', 'yes', 'yes', 'yes');
...
--
-- Déchargement des données de la table `crud_field`
--
...
(10, 1, 'id', 'id', 'number', '', '', '', '', 1, '', '', ''),
(11, 1, 'designation_commune', 'Designation', 'input', 'yes', 'yes', 'yes', 'yes', 2, '', '', ''),
(12, 1, 'date_test', 'date', 'timestamp', 'yes', 'yes', 'yes', 'yes', 3, '', '', '');
...
--
-- Déchargement des données de la table `crud_field_validation`
--
...
--
-- Déchargement des données de la table `crud_input_type`
--
...
--
-- Déchargement des données de la table `crud_input_validation`
--
...
(1, 0, '9DC22730A98F624C003307FE5B71045C', 0, 0, 0, NULL, '2022-01-03 14:12:35');
...
--
-- Déchargement des données de la table `menu_type`
--
...
--
-- Déchargement des données de la table `rest_input_type`
--
...
CREATE TABLE `test` (
  `id` int(8) NOT NULL,
  `designation_commune` varchar(100) DEFAULT NULL,
  `date_test` varchar(100) DEFAULT NULL
...
INSERT INTO `test` (`id`, `designation_commune`, `date_test`) VALUES
(1, 'ver', '2022-01-03 22:25:11'),
(2, 'claude', '2022-01-03 22:25:18');
